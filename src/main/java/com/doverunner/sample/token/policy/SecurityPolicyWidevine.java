...
@JsonPropertyOrder({"security_level", "required_hdcp_version", "required_cgms_flags",
        "disable_analog_output", "hdcp_srm_rule", "override_device_revocation", "enable_license_cipher", "allow_test_device"})
...
public class SecurityPolicyWidevine {
    ...
    @JsonProperty("allow_test_device")
    private Boolean allowTestDevice = true;
    ...
    public SecurityPolicyWidevine allowTestDevice(Boolean allowTestDevice) {
        this.allowTestDevice = allowTestDevice;
        return this;
    }
