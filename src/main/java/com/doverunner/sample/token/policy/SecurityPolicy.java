...
@JsonPropertyOrder({
        "track_type", "widevine", "playready", "fairplay", "ncg", "wiseplay"
})
public class SecurityPolicy {
    ...
    @JsonProperty("wiseplay")
    private SecurityPolicyWiseplay wiseplay;
    ...
    public SecurityPolicy wiseplay(SecurityPolicyWiseplay wiseplay) {
        this.wiseplay = wiseplay;
        return this;
    }
    ...
    public SecurityPolicyWiseplay getWiseplay() { return this.wiseplay; }
}
