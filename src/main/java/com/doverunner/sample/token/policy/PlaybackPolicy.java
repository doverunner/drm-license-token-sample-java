...
@JsonPropertyOrder({"persistent", "license_duration", "expire_date", "allowed_track_types", "rental_duration", "playback_duration", "max_stream_per_user", "renewal_duration"})
public class PlaybackPolicy {
    ...
    public PlaybackPolicy renewalDuration(int renewalDuration) {
    ...
    public  Integer getRenewalDuration() { return renewalDuration; }
}
