...
public class PallyConDrmTokenPolicy2 {
    ...
    public PallyConDrmTokenPolicy2(PolicyBuilder policyBuilder) {
    ...
    public static class PolicyBuilder{
        ...
        public PallyConDrmTokenPolicy2 build() throws PallyConTokenException {
            PallyConDrmTokenPolicy2 policy = new PallyConDrmTokenPolicy2(this);
